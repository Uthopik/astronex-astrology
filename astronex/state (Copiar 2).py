...
class Current(object):
    ...
    def init(self, app):
        ...
        # --- RE-FORZADO TOTAL ---
        # No importa lo que haya cargado el pickle, aquí mandamos nosotros:
        self.loc.city = 'Las Palmas de Gran Canaria'
        self.loc.longdec = -15.41
        self.loc.latdec = 28.12
        self.loc.zone = 'Atlantic/Canary'
        self.loc.country = 'ES'
        self.loc.region = 'Canarias'

        # ¡ESTO ES LO NUEVO!: 
        # Obligamos a la carta 'now' (el reloj) a recalcularse con los decimales de Las Palmas
        # Si no haces esto, el texto dirá "Las Palmas" pero el dibujo usará el dato viejo.
        self.refresh_nowchart() 
        # ------------------------
