...
class DrawPdf(object):
    ...
    def clicked(boss):
        ...
        # 5. Salida temprana si se cancela (Indentado correctamente)
        if not filename:
            return
        ...
        if sys.platform == 'win32':
            ...
            # Usamos xdg-open por defecto si opts no está disponible
            viewer = getattr(boss.opts, 'pdfviewer', 'xdg-open')
